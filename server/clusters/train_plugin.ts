...
export default function (Client: any, config: any, components: any) {
  ...
  if (!Client.prototype.ml_commons_train) {
    Client.prototype.ml_commons_train = components.clientAction.namespaceFactory();
  }

  const mlCommonsTrain = Client.prototype.ml_commons_train.prototype;
