...
export default function (Client: any, config: any, components: any) {
  ...
  if (!Client.prototype.ml_commons_model) {
    Client.prototype.ml_commons_model = components.clientAction.namespaceFactory();
  }

  const mlCommonsModel = Client.prototype.ml_commons_model.prototype;
